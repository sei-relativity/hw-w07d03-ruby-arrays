...
#     if index[:products][0][:price]>index[:products][1][:price]
#         most_expensive_products_by_store.push({store_name: index[:store_name], most_expensive_products: index[:products][0]})
#     else
#         most_expensive_products_by_store.push({store_name: index[:store_name], most_expensive_products: index[:products][1]})
#     end
